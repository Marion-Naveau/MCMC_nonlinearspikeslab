...
nb_iter_finish=0
save(nb_iter_finish,file="Nb_iter_Test_cvMCMC_p500.Rdata")
...
Res_Tot<-foreach(s = 1:S, .packages = c("nlme","mvnfast","doParallel","ggplot2","cowplot","glmnet","microbenchmark","tidyverse","nimble")) %dopar% {
  ...
  load("Nb_iter_Test_cvMCMC_p500.Rdata")
...
save(Res_Tot,file="Res_Test_cvMCMC_p500_2.Rdata")

#load("Res_Test_cvMCMC_p500.Rdata") #Gamma2_init=5000
load("Res_Test_cvMCMC_p500_2.Rdata") #Gamma2_init=500
