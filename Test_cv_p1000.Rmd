...
# #data_input=Simul_donnees_Marion avec p=1000
#set.seed(1)
#mcmc_out=FitOneVariableParamSpikeAndSlabDelay_marginal_delta_slow(data = data_input, nu_0 = nu_0, niter = 5000)

#save(mcmc_out,file="Test_cv_MCMC_p1000.Rdata")
