...
# #data_input=Simul_donnees_Marion avec p=500
#set.seed(1)
#mcmc_out=FitOneVariableParamSpikeAndSlabDelay_marginal_delta_slow(data = data_input, nu_0 = nu_0, niter = 3000)

#save(mcmc_out,file="Test_cv_MCMC_p500.Rdata")

load("Test_cv_MCMC_p500_2.Rdata")
```
